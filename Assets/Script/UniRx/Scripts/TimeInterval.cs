...
namespace UniRx
{
    ...
    /// The time interval can represent the TimeAnimation it took to produce the value, the interval relative to a previous value, the value's delivery TimeAnimation relative to a base, etc.
    /// </summary>
