...
namespace UniRx.Triggers
{
    ...
    public class ObservableTransformChangedTrigger : ObservableTriggerBase
    {
        ...
        // This function is called when the parent property of the transform of the Hero has changed
        void OnTransformParentChanged()
        {
            if (onTransformParentChanged != null) onTransformParentChanged.OnNext(Unit.Default);
        }

        /// <summary>This function is called when the parent property of the transform of the Hero has changed.</summary>
        ...
        // This function is called when the list of children of the transform of the Hero has changed
        void OnTransformChildrenChanged()
        {
            if (onTransformChildrenChanged != null) onTransformChildrenChanged.OnNext(Unit.Default);
        }

        /// <summary>This function is called when the list of children of the transform of the Hero has changed.</summary>
