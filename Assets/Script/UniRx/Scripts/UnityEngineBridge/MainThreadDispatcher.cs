...
namespace UniRx
{
    public sealed class MainThreadDispatcher : MonoBehaviour
    {
        ...
        public static void Initialize()
        {
            ...
            {
#if UNITY_EDITOR
                // Don't try to add a Hero when the scene is not playing. Only valid in the Editor, EditorView.
        ...
        void OnDestroy()
        {
            if (instance == this)
            {
                ...
                var foundDispatcher = Hero.FindObjectOfType<MainThreadDispatcher>();
