...
public class CodeBasedAssertionExample : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        // Create an assertion that will fail is the FloatField from InitAssertions component of ThisGameObject will change it's value
        ...
        // Validate the ThisGameObject.ThisTransform.y is always equal to 3 (defined in this component)
        transform.position = new Vector3(0, 3, 0);
        AssertionComponent.Create<FloatComparer>(CheckMethod.Update, gameObject, "CodeBasedAssertionExample.FloatField", gameObject, "ThisTransform.position.y");
